...
var C4GMapsRouter=function(mapData,map) {
	...
	router.setRouteMode = function() {
		...
		if (zpPanel) { zpPanel.addClass('c4gMapsRouterDialogActive') }
	...
	router.clearRouteMode = function(destroy) {
		...
		zpPanel = document.getElementById('C4GMapsZoomPositionPanel_' + mapData.id);
		if (zpPanel) { zpPanel.removeClass('c4gMapsRouterDialogActive') }
	...
	router.createPanel = function(fromLonLat,toLonLat) 
	{
		...
		this.routerWrapperDiv.removeClass('c4gPortsideInactive');
		this.routerIcon.addClass('olControlRouterIconActive');
		this.routerIcon.removeClass('olControlRouterIconInactive');
	...
	{
		this.routerWrapperDiv.addClass('c4gPortsideInactive');
		this.routerIcon.removeClass('olControlRouterIconActive');
		this.routerIcon.addClass('olControlRouterIconInactive');
