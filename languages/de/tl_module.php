...
$GLOBALS['TL_LANG']['tl_module']['c4g_map_layer_switcher'] = array('Starboard', 'Wenn Sie diese Checkbox auswählen, dann bekommt die Karte ein Starboard (erreichbar über ein Stern-Symbol rechts oben), das es ermöglicht, zwischen den im Kartenprofil definierten Basiskarten zu wechseln. Außerdem können im Starboard ggfs. in der Kartenstruktur definierte Ebenen ein- und ausgeschaltet werden.');
$GLOBALS['TL_LANG']['tl_module']['c4g_map_layer_switcher_open'] = array('Starboard automatisch öffnen', 'Wenn Sie diese Checkbox auswählen, dann wird das Starboard sofort geöffnet angezeigt.');
$GLOBALS['TL_LANG']['tl_module']['c4g_map_layer_switcher_ext'] = array('Starboard - Ebenen im Baum darstellen', 'Wenn Sie diese Checkbox auswählen, dann werden die auswählbaren Ebenen im Baum dargestellt. Voraussetzung ist eine hierarchische Definition der Ebenen bei den Kartenstrukturelementen. Achtung! Es werden mehrere Javascript-Bibliotheken (u.a. jQuery) der Seite hinzugefügt.');
