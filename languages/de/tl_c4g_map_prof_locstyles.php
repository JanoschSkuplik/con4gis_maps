...
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['label'] 			 = array('Label', 'Geben Sie hier ein Label ein, das auf der Karte bei der Lokation mit angezeigt wird. Überschreibt Einstellung am Kartenelement!');
...
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['tooltip'] 		 = array('Tooltip für Icons', 'Kurze Information, die angezeigt wird, wenn der Mauszeiger über der Lokation für eine kurze Zeit stehen bleibt. Überschreibt Einstellung am Kartenelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['popup_info'] 		 = array('Popup Information', 'Wird eine Popup-Information gesetzt, so wird sie durch einen Mausklick oder via Hover (abhängig von der Einstellung im Kartenprofil) auf der Lokation angezeigt. Überschreibt Einstellung am Kartenelement!');
...
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['onclick_zoomto'] 	 = array('Zoomen bei Mausklick auf Zoomstufe', 'Geben Sie die Zoomstufe ein, auf die bei Mausklick gezoomt werden soll. Funktioniert nur, wenn keine Direktverlinkung angegeben ist. Überschreibt Einstellung am Kartenelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['minzoom'] 		 = array('Mindest-Zoomstufe', 'Geben Sie die Zoomstufe ein, ab der die Elemente des Karteneintrags angezeigt werden. 0=keine Einschränkung. Überschreibt Einstellung am Kartenelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_prof_locstyles']['maxzoom'] 		 = array('Maximale Zoomstufe', 'Geben Sie die Zoomstufe ein, bis zu der die Elemente des Karteneintrags angezeigt werden. 0=keine Einschränkung. Überschreibt Einstellung am Kartenelement!');
