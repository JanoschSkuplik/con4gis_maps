...
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['icon_size']        = array('Größe des Icons','Die Größe des Icons auf der Karte. Wird gegebenenfalls skaliert.');
...
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['line_arrows_radius']= array('Radius des Pfeils in Pixeln','Der Pfeil wird mit einem Dreieck-Symbol dargestellt. Geben Sie hier den Radius in Pixeln ein.');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['line_arrows_minzoom'] = array('Pfeile zeigen ab Zoomlevel','Mindest-Zoomlevel, ab dem die Pfeile angezeigt werden sollen. 0=immer zeigen.');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['label'] 		       = array('Label', 'Geben Sie hier ein Label ein, das auf der Karte bei der Lokation mit angezeigt wird. Überschreibt die Einstellung am Kartenstrukturelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['label_align_hor']  = array('Horizontale Ausrichtung ','Bitte definieren Sie, wie sich das Label relativ zum Lokation horizontal ausrichten soll.');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['label_align_ver']  = array('Vertikale Ausrichtung','Bitte definieren Sie, wie sich das Label relativ zum Lokation vertikal ausrichten soll.');
...
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['tooltip'] 		 = array('Tooltip für Icons', 'Kurze Information, die angezeigt wird, wenn der Mauszeiger über der Lokation für eine kurze Zeit stehen bleibt. Überschreibt die Einstellung am Kartenstrukturelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['popup_info'] 		 = array('Popup Information', 'Wird eine Popup-Information gesetzt, so wird sie durch einen Mausklick oder via Hover (abhängig von der Einstellung im Kartenprofil) auf der Lokation angezeigt. Überschreibt die Einstellung am Kartenstrukturelement!');
...
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['popup_offset']     = array('Positionsversatz des Popups (X/Y) in Pixel','Bei einem Versatz von "0" befindet sich die obere linke Ecke des Popups an der angegebenen Geo-Lokation. X=Positiv => nach rechts. X=negativ => nach links. Y=positiv => nach unten. Y=negativ => nach oben.');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['onclick_zoomto'] 	 = array('Zoomen bei Mausklick auf Zoomstufe', 'Geben Sie die Zoomstufe ein, auf die bei Mausklick gezoomt werden soll. Funktioniert nur, wenn keine Direktverlinkung angegeben ist. Überschreibt die Einstellung am Kartenstrukturelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['minzoom'] 		 = array('Mindest-Zoomstufe', 'Geben Sie die Zoomstufe ein, ab der die Elemente des Karteneintrags angezeigt werden. 0=keine Einschränkung. Überschreibt die Einstellung am Kartenstrukturelement!');
$GLOBALS['TL_LANG']['tl_c4g_map_locstyles']['maxzoom'] 		 = array('Maximale Zoomstufe', 'Geben Sie die Zoomstufe ein, bis zu der die Elemente des Karteneintrags angezeigt werden. 0=keine Einschränkung. Überschreibt die Einstellung am Kartenstrukturelement!');
